...
SECRET_KEY = '=ug_ucl@yi6^mrcjyz%(u0%&g2adt#bz3@yos%#@*t#t!ypx=ai'
...
LOCAL_APPS = [
    ...
    # 'app.testing_examples.apps.TestingExamplesConfig',
]
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [('redis', 6379)],  # Use the service name `redis` from your docker-compose file
        },
    },
}
